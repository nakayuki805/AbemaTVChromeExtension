...
var notifyContent = "AbemaTV Chrome拡張(_bem_tv ext)の最近追加された機能をご存知ですか？<br>最近のアップデートで番組開始前通知やそのときに自動で画面を開く機能(要設定)のほかコメント欄のスタイルを変えれたりいくつかの機能が追加されています。<br><b>この拡張機能のオプション設定画面を長らく開いていなければ開いて新たな機能を確認してみてください。</b><br>この拡張機能はAbemaTVの仕様変更によりある日突然うまく動かなくなることがあります。その際はアップデートをお待ちください。";
