...
var notifyContent = "現在、一部の環境でCM開始直前に画面が小さくなってしまう現象が確認されています。<br><b>この拡張機能の<a href='"+optionUrl+"' target='_blank'>オプション設定画面</a>の下のある「コメント無効時関連リセット」ボタンを試してください。</b><br>設定リセットボタンはアップデートで新たに追加されました。";
