...
var notifyContent = "新着コメントを少し目立たせる機能(設定で有効)が追加されました。<br>abematv拡張機能の実験的なfirefox版<a href='https://www.nakayuki.net/abema-ext/' target='_blank'>公開中</a>です。<br>再掲:CM開始直前に画面が小さくなってしまう場合はこの拡張機能の<a href='"+optionUrl+"' target='_blank'>オプション設定画面</a>の下のある「コメント無効時関連リセット」ボタンを試してください。";
