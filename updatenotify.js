...
var notifyContent = "最近追加された機能(デフォルト無効):「Twitterで通知を受け取る」放送画面の「今日のみどころ」の非表示オプション、番組表の表示改善<br>必要に応じて有効にしてください→<a href='"+optionUrl+"' target='_blank'>オプション設定画面</a><br>abematv拡張機能の実験的なfirefox版<a href='https://www.nakayuki.net/abema-ext/' target='_blank'>公開中</a>です。";
