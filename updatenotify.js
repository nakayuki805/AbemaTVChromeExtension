...
var notifyContent = "最近追加された機能(※デフォルト無効):<br>映像を左や上に詰めるオプション追加<br>右コメ欄NG反映時、コメントを選択して右クリックでNGワード追加できるようになりました。(Firefox非対応)<br>流れるコメントのフォントサイズを変えれるようになりました。<br>映像リサイズオプションが変更されました。<br>v0.4.0より共有NGワードに対応しました。※<br>v0.3.0よりNG設定を流れるコメントだけではなく右のコメント欄にも反映させることも可能になりました。※<br><b>設定変更により機能が有効</b>になるので必要に応じて有効にしてください。→<a href='"+optionUrl+"' target='_blank'>オプション設定画面</a><br>拡張機能のユーザー数1万突破しました！<br>abematv拡張機能の実験的なfirefox版<a href='https://www.nakayuki.net/abema-ext/' target='_blank'>公開中</a>です。";
